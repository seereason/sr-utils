...
-- | No-op version of spliceModule.  We do not want to generate
-- splices when building with ghc9 because they differ from the
-- splices generated by ghc8.  Unfortunately, that means the
-- SplicesForFoo.hs files may be out of date when you refer to them to
-- see what template haskell is outputting.
spliceModule :: Text -> [Dec] -> Q [Dec]
spliceModule _header decs = pure decs
#endif
